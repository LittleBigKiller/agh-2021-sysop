...
while True:
    ...
    for socks in read_sockets:
        ...
        if socks == cli_socket:
            ...
            message = decrypt(my_password, cli_socket.recv(message_length)).decode('utf-8')
        ...
        # Jeżeli nie otrzymaliśmy wiadomości z zewnątrz, to musieliśmy ją napisać na terminalu
            ...
            message = (encrypt(my_password, message.encode('utf-8')))
            ...
            sys.stdout.write(decrypt(my_password, message).decode('utf-8') + '\n')
            # wymuszam wypisanie danych na terminal (na wszelki wypadek)
            sys.stdout.flush()
